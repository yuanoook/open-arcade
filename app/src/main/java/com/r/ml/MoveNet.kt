...
class MoveNet(private val interpreter: Interpreter, private var gpuDelegate: GpuDelegate?) :
    ...
    companion object {
        ...
        // TFLite file names.
        private const val LIGHTNING_FILENAME_INT8 = "movenet_lightning_int8.tflite"
        private const val THUNDER_FILENAME_INT8 = "movenet_thunder_int8.tflite"
            ...
            return MoveNet(
                Interpreter(
                    FileUtil.loadMappedFile(
                        ...
                        else if (modelType == ModelType.LightningInt8) LIGHTNING_FILENAME_INT8
                        else if (modelType == ModelType.Thunder) THUNDER_FILENAME
                        else if (modelType == ModelType.ThunderInt8) THUNDER_FILENAME_INT8
                        else LIGHTNING_FILENAME_INT8
                    ), options
                ),
                gpuDelegate
            )
